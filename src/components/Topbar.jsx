        ...
        <Container fluid='lg' className='  '>
          ...
          <Navbar.Collapse id='navbarScroll'>
            ...
            <Nav className='ms-auto my-2 my-lg-0 gap-2 align-items-center' style={{ maxHeight: "100px" }} navbarScroll>
              <NavLink to={"/me"} className='text-black text-decoration-none'>
              ...
              <NavLink to={"/me"} className='text-decoration-none text-black'>
                <div className='d-flex flex-column align-items-center'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    viewBox='0 0 24 24'
              ...
              <NavLink to={"/"} className='text-gratis text-decoration-underline d-flex align-items-center'>
